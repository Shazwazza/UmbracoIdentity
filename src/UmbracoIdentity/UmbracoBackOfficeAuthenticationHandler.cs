...
namespace UmbracoIdentity
{
    ...
    //{
    //    public UmbracoBackOfficeAuthenticationHandler(IUmbracoSettingsSection umbSettings)
    //    {
    //        _umbSettings = umbSettings ?? throw new ArgumentNullException(nameof(umbSettings));
    //    }
    ...
    //        {
    //            var authTicket = GetAuthTicket(Request, _umbSettings.Security.AuthCookieName);
    //            if (authTicket != null)
    //            {
    ...
    //    private readonly IUmbracoSettingsSection _umbSettings;
